      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center border border-gray-200 rounded-md bg-gray-50 pl-2 pr-1 py-1 mr-2">
          ...
          <select 
            ...
            className="text-xs font-semibold bg-transparent border-none text-[#0A192F] outline-none cursor-pointer"
          >
        ...
        {/* User Profile */}
        <button className="flex items-center gap-3 text-left hover:bg-gray-50 p-1 pr-2 rounded-full border border-transparent hover:border-gray-200 transition-all">
          <img
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-semibold text-gray-900 leading-none">Eleanor Pena</p>
